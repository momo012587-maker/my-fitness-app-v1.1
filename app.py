# 1. 自動安裝所需套件與通道工具 (會跑個幾十秒，請稍候)
!pip install streamlit pandas plotly -q
!npm install -g localtunnel -q

# 2. 將我們寫好的 App 程式碼自動存成檔案 (強制使用 UTF-8 避免中文亂碼)
app_code = """
...
with tab3:
    if c_w > 0:
        ...
        * **🚶‍♂️ 基礎活動 (每日)：** 把握拜訪客戶的通勤空檔，維持每日 8000 步底線。
...
print("="*50)
print(f"✅ 貓咪已準備就緒！你的專屬密碼 (Tunnel Password) 是： {ip}")
print("👉 請複製上方這串數字！")
print("👉 等下方出現 'your url is: https://...' 的網址時，點擊它並貼上密碼！")
print("="*50)
